...
final List<Map> oriRoutes = [
  ...
  {"title": FadeWidget.name, "path": "/fade_widget", "fun": (context) => FadeWidget()},
  ...
  {"title": SplashScreen.name, "path": (SplashScreen).toString().underscore().toRoutePath(), "fun": (context) => SplashScreen()},
  {"title": SignIn.name, "path": (SignIn).toString().underscore().toRoutePath(), "fun": (context) => SignIn()},
  {"title": ForgotPassword.name, "path": (ForgotPassword).toString().underscore().toRoutePath(), "fun": (context) => ForgotPassword()},
  {"title": LoginSuccess.name, "path": (LoginSuccess).toString().underscore().toRoutePath(), "fun": (context) => LoginSuccess()},
  {"title": SignUp.name, "path": (SignUp).toString().underscore().toRoutePath(), "fun": (context) => SignUp()},
  {"title": CompleteProfile.name, "path": (CompleteProfile).toString().underscore().toRoutePath(), "fun": (context) => CompleteProfile()},
  {"title": OptScreen.name, "path": (OptScreen).toString().underscore().toRoutePath(), "fun": (context) => OptScreen()},
  {"title": HomeScreen.name, "path": (HomeScreen).toString().underscore().toRoutePath(), "fun": (context) => HomeScreen()},
  {"title": ProductDetail.name, "path": (ProductDetail).toString().underscore().toRoutePath(), "fun": (context) => ProductDetail()},
  {"title": CartScreen.name, "path": (CartScreen).toString().underscore().toRoutePath(), "fun": (context) => CartScreen()},
  {"title": ProfileScreen.name, "path": (ProfileScreen).toString().underscore().toRoutePath(), "fun": (context) => ProfileScreen()},
];
